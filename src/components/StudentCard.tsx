        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-40 h-40 md:w-44 md:h-44 mb-6 rounded-full overflow-hidden border-[3px] border-white dark:border-slate-700 shadow-lg transition-transform duration-300 group-hover:scale-[1.03]">
                        <Image
