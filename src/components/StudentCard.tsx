...
export default function StudentCard({ student }: StudentCardProps) {
    ...
    return (
        ...
        >
            <div
                className={`w-full h-full transition-transform duration-[600ms] ease-[cubic-bezier(0.22,1,0.36,1)] preserve-3d cursor-pointer will-change-transform ${isFlipped ? "rotate-y-180" : ""}`}
            >
                {/* ── FRONT ── */}
                <div
